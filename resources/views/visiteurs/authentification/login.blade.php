            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="{{route('envoyer_message')}}" method="POST" class="mb-4">
                        @csrf
                        <div class="row g-4">
                            {{-- <div class="error-message" style="padding-top: 0px">
                            </div> --}}
                            <div class="col-lg-12">
                                <input type="email" class="w-100 form-control border-0 py-3" name="email_visiteur" placeholder="Adresse email *" required>
                            </div>
                            <div class="col-lg-12">
                                <input type="password" class="w-100 form-control border-0 py-3" name="telephone" placeholder="Mot de passe *">
                            </div>
                            <div class="col-lg-12">
                                <p>Vous n'avez pas un compte?<a href="{{route('register_user')}}"> Créer un compte.</a></p>
                                <p style="text-align: right">Mot de passe oublié?<a href="{{route('register_user')}}"> Recupérer mon compte.</a></p>
                            </div>
                            <div class="col-12">
                                <button class="w-100 btn btn-primary form-control py-3" type="submit">Me connecter</button>
                            </div>
                        </div>
                    </form>
                    <div class="col-12">
                        <a target="_blank" href="{{route('login_recruteur')}}"><button class="w-100 btn btn-primary form-control py-3">Espace recruteur</button></a>
                    </div>
                    {{-- <div class="row g-4">
                        <div class="col-xl-6">
