            ...
            <div class="row g-4">
                <div class="col-lg-8 col-xl-9">
                    ...
                    <div class="mt-5 lifestyle">
                        <div class="border-bottom mb-4">
                            <h1 class="mb-4">Toute l'actualité</h1>
                        </div>
                        <div class="row g-4">
                            @foreach ($actualites as $actualite)
                            <div class="col-lg-4">
                                <div class="lifestyle-item rounded">
                                    <img style="height: 300px; width: 100%; object-fit: cover" src="/storage/{{$actualite->image_actualite}}" class="img-fluid w-100 rounded" alt="">
                                    <div class="lifestyle-content">
                                       <div class="mt-auto">
                                            <a href="{{route('news_view_more', ['id'=>$actualite->id])}}" class="h6 text-white link-hover">{{$actualite->titre}}</a>
                                            <div class="d-flex justify-content-between mt-4">
                                                <a href="#" class="small text-white link-hover">{{$actualite->name}}</a>
                                                <small style="font-size: 12px" class="text-white d-block"><i class="fas fa-calendar-alt me-1"></i> {{ \Carbon\Carbon::parse($actualite->updated_at)->format('l, d-m-Y') }}</small>
                                            </div>
                                       </div>
                                    </div>
                                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="p-3 rounded border">
                                <h4 class="mb-4">Nos reseaux sociaux</h4>
                                <div class="row g-4">
                                    <div class="col-12">
                                ...
                                <h4 class="my-4">Offres pour Micro-jobs.</h4>
                                <div class="row g-4">
                                    <div class="col-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="position-relative banner-2">
                                            <img src="{{asset('templates/visiteurs/img/banner-2.jpg')}}" class="img-fluid w-100 rounded" alt="">
