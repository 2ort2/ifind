    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Paramètre de configuration</h5>
          <p>Adaptez l'application à votre goût.</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">Choisir une des deux couleurs comme fond d'écran.</p>
        </div>
        <div class="d-flex">
        ...
        <div class="d-flex my-3">
          <h6 class="mb-0">Navbar couleur</h6>
        ...
        <div class="mt-2 mb-5 d-flex">
          <h6 class="mb-0">Fond blanc ou noir</h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
