@extends('recruteurs.authentification.app',['title'=>'Inscription'])
@section('css')
<style>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white" style="font-style: italic; font-size: 14px">Renseignez les informations concernant votre entreprise, un administrateur analysera la validité de ces informations, puis confirmera ou non la creation du compte, un email vous sera envoyer dans tous les cas.</p>
          </div>
        </div>
      </div>
    </div>
