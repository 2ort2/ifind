        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="" action="{{route('ajouter_actualite')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control"  name="titre" placeholder="Titre de l'actualité*" required="required" />
                                </div>
                            </div>
                            <div class="field item form-group">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea required="required" name='contenu' id="contenu"></textarea>
                                </div>
                            </div>
                            <div class="ln_solid">
