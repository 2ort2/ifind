<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
      <div class="navbar nav_title" style="border: 0;">
        <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>I-FIND</span></a>
      </div>
      ...
      <div class="profile clearfix">
        <div class="profile_pic">
          <img src="{{asset('/templates/administrateurs/production/images/img.jpg')}}" alt="Profil" class="img-circle profile_img">
        </div>
      ...
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        ...
        <div class="menu_section">
          ...
          <ul class="nav side-menu">
            <li><a><i class="fa fa-bug"></i> Visiteurs<span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                <li><a href="{{route('liste_des_messages_non_lus')}}">Messages non lu</a></li>
                <li><a href="{{route('liste_des_messages_non_repondu')}}">Non repondu</a></li>
                <li><a href="project_detail.html">Repondu</a></li>
              </ul>
            </li>
            {{-- <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
