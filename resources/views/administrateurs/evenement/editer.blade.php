        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="" action="{{route('modifier_evenement')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control"  name="titre" placeholder="Titre de l'évenement*" required="required" value="{{$evenementdispo->titre}}"/>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control"  name="lieu" placeholder="lieu de l'évenement*" required="required" value="{{$evenementdispo->lieu}}"/>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="datetime-local" name="date_debut" placeholder="Date début*" required="required" value="{{$evenementdispo->date_debut}}"/>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="datetime-local" name="date_fin" placeholder="Date fin*" required="required" value="{{$evenementdispo->date_fin}}"/>
                                </div>
                            </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea required="required" name='description' id="description">{{$evenementdispo->description}}</textarea>
                                </div>
                            </div>
                            <div class="ln_solid">
