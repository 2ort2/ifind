    ...
    <div class="">
      <div class="page-title">
        <div class="title_left">
          <h3>Liste de messages non lus.</h3>
        </div>
            ...
            <div class="x_content">
              ...
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$numero}}</td>
                        <td>{{$message_non_lu->nom_visiteur}}</td>
                        <td><a target="_blank" href="mailto:{{$message_non_lu->email_visiteur}}">{{$message_non_lu->email_visiteur}}</a></td>
                        <td>{{$message_non_lu->objet}}</td>
                        <td>{{$message_non_lu->created_at}}</td>
                        <td style="text-align: center">
                            <a href="{{route('lire_message_visiteur_delete',['id'=>$message_non_repondu -> id])}}"><i class="fa fa-trash"></i></a>
                            <a href="{{route('lire_message_visiteur',['id'=>$message_non_lu -> id])}}"><i class="fa fa-pencil-square"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
